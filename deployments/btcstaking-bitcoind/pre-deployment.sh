...
mkdir -p .testnets/btc-validator0
mkdir -p .testnets/btc-validator1
mkdir -p .testnets/btc-validator2
...
cp artifacts/vald.conf .testnets/btc-validator0/vald.conf
cp artifacts/vald.conf .testnets/btc-validator1/vald.conf
cp artifacts/vald.conf .testnets/btc-validator2/vald.conf
